...
top.dungeons = [
  ...
  {"title": "d6 Questo posto è un/una...", "id":"d6thisplaceisa_elementalwaterdungeon", "roll":[
  "Caverna marina.",
  "Serie di tunnel allagati nelle profondità.",
  "Forte costruito da esseri acquatici.",
  "Tempio dedicato ad un dio marino.",
  "Palazzo costruito da un lord elementale dell'acqua.",
  "Fognatura finita male.",   ]},
   {"title": "d6 Livello dell'acqua Le stanze in questo luogo...", "id":"d6waterlevelthechambersinthisplace_elementalwaterdungeon", "roll":[
  "Sono sempre sommerse fino al soffitto.",
  "Sono sempre sommerse nei livelli inferiori.",
  "Sono sempre sommerse fino alla vita.",
  "Si riempiono d'acqua con l'alta marea.",
  "Si riempiono d'acqua a seconda della stagione.",
  "Si riempiono d'acqua a seconda del volere di un elementale.",   ]},
   {"title": "d6 Caratteristica maggiore Vedi un/una...", "id":"d6majorfeatureyouseeaan_elementalwaterdungeon", "roll":[
  "Sacca d'aria.",
  "Altare ad un dio marino.",
  "Pesante forziere.",
  "Rastrelliera di arpioni e/o lance.",
  "Scheletro di un mortale affogato.",
  "Barriera corallina.",   ]},
   {"title": "d6 Caratteristica minore Vedi un/una..", "id":"d6minorfeatureyouseea_elementalwaterdungeon", "roll":[
  "Piccola scia di bolle.",
  "Icona ad un dio marino.",
  "Detrito di una nave.",
  "Banco di pesci.",
  "Pezzo di tessuto strappato.",
  "Sacca d'acqua fredda.",   ]},
   {"title": "d6 NPC Incontri un/una…", "id":"d6npcyoumeetaan…_elementalwaterdungeon", "roll":[
  "Fantasma di un contrabbandiere.",
  "Sirena curiosa.",
  "Elfo marino sospettoso.",
  "Eccentrico cacciatore di tesori.",
  "Cultista elementale mezzo matto.",
  "Un animorfo solitario (tira sulla tabella delle bestie).",   ]},
   {"title": "d6 Bestie Incontri un/una…", "id":"d6beastyoumeetaan…_elementalwaterdungeon", "roll":[
  "Delfino.",
  "Mollusco gigante.",
  "Aragosta.",
  "Polpo.",
  "Foca.",
  "Squalo.",   ]},
   {"title": "d6 Mostro secondario Ti imbatti in un/una…", "id":"d6secondarymonsteryoucomeuponaan…_elementalwaterdungeon", "roll":[
  "Bestia marina aberrante (tira sulla tabella delle bestie).",
  "Sciame di granchi o pesci carnivori.",
  "Kuo-toa.",
  "Sahuagin.",
  "Sea hag.",
  "Elementale dell'Acqua.",   ]},
   {"title": "d6 Mostro primario Questo posto è attualmente controllato da…", "id":"d6primarymonsterthisplaceiscurrentlyruledbya…_elementalwaterdungeon", "roll":[
  "Aboleth.",
  "Drago Blu.",
  "Kraken.",
  "Principe Maridan.",
  ...
  "Anguille elettriche.",
  "Meduse velenose.",
  "Trappole di dardi avvelenati.",
  "Camere allaganti.",
  "Correnti marine.",
  "Maledizione della morte in decomposizione.",   ]},
   {"title": "d6 Tesoro/Premio Se sopravvivi, potresti trovare...", "id":"d6rewardtreasureifyousurviveyoumayfind_elementalwaterdungeon", "roll":[
  "Il tesoro di un capitano pirata.",
  "Una staffa dal potere elementale.",
  "Un'antica arma forgiata in corallo.",
  "Una leggendaria gemma persa in mare.",
  "La chiave per aprire un portale verso un altro regno.",
 ...
 "Palazzo costruito da un lord elementale della terra.",
 "Tempio dedicato ad un dio della terra.",
 "Fortezza costruita da entità della terra.",
 "Serie di tunnel instabili nelle profondità.",
 "Labirinto di solida roccia.",
 "Operazione di scavi finita male.",   ]},
  {"title": "d6 Pavimento/Terreno Spesso cammini su...", "id":"d6floorterrainyoufrequentlystepon_elementalearthdungeon", "roll":[
 "Polvere scivolosa.",
 "Fango denso che ti blocca gli stivali.",
 "Macerie varie.",
 "Ghiaia.",
 "Rocce frastagliate.",
 "Spunzoni metallici affilati.",   ]},
  {"title": "d6 Caratteristica maggiore Vedi un/una...", "id":"d6majorfeatureyouseeaan_elementalearthdungeon", "roll":[
 "Monolito di pietra.",
 "Altare ad un dio della terra",
 "Statua o figura fatta di pietra o ferro.",
 "Ponte naturale di pietra.",
 "Serie di colonne di pietra.",
 "Profondo abisso.",   ]},
  {"title": "d6 Caratteristica minore Noti un/una...", "id":"d6minorfeatureyounoticeaan_elementalearthdungeon", "roll":[
 "Piccola statua di pietra.",
 "Icona di un dio della terra.",
 "Stalattite.",
 "Breve tremore.",
 "Suono rombante lontano.",
 "Mulinello di polvere.",   ]},
  {"title": "d6 NPC Incontri un/una…", "id":"d6npcyoumeetaan…_elementalearthdungeon", "roll":[
 "Fantasma di uno sfortunato cacciatore di tesori.",
 "Cultista elementale mezzo matto.",
 "Prospettore nano.",
 "Monaco in meditazione.",
 "Elfo Oscuro vagabondo.",
 "Inventore di un aggeggio scavatore.",   ]},
  {"title": "d6 Bestie Incontri un/una…", "id":"d6beastyoumeetaan…_elementalearthdungeon", "roll":[
 "Talpa gigante.",
 "Sciame di ratti.",
 "Centopiedi gigante.",
 "Formica gigante.",
 "Lombrico gigante.",
 "Gelatina fangosa.",   ]},
  {"title": "d6 Mostro secondario Ti imbatti in un/una…", "id":"d6secondarymonsteryoucomeuponaan…_elementalearthdungeon", "roll":[
 ...
 "Zombie.",
 "Otyugh.",   ]},
  {"title": "d6 Mostro primario Questo posto è attualmente controllato da un/una…", "id":"d6primarymonsterthisplaceiscurrentlyruledbyaan…_elementalearthdungeon", "roll":[
 "Principe Dao.",
 "Gigante di pietra.",
 "Drago antico.",
 "Potente geomante.",
 ...
 "Fossa di fango nauseante.",
 "Trappole di muri che crollano.",
 "Trappole di pareti rotanti con spunzoni (kissing maidens).",
 "Trappole di spunzoni che sbucano dal pavimento.",
 "Archi e ponti collassanti.",
 "Soffitti collassanti.",   ]},
 ...
 "Il libro d'incantesimo di un noto necromante.",
 "Globo del potere elementale.",
 "Vena di minerale prezioso (oro, platino, adamantio, o mithril).",
 "Diamante delle leggende naniche.",
 "Martello brandito da un guerriero semidio.",
 "Demone imprigionato.",   ]},
